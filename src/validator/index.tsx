 ...
 */
export const isValidatorNumber = (
  rule: any,
  value: any,
  callback: any,
  percison = 2,
  intNumberLength: number,
) => {
 ...
 */
export const handlePicture = (image: any) => {
  let data = undefined;
  ...
  if (data && Array.isArray(data)) {
    if (data.length) {
      ...
      for (const item of data) {
        ...
        const typeValue =
          Array.isArray(arr) && arr.length == 2 ? arr[1] : undefined;
...
/*
        处理枚举对象
    */
export const getEnumArr = (objArr: any) => {
  const arr =
